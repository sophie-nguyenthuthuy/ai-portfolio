"""API tests: health/ready/metrics, predict, model/info via TestClient."""
...
def test_predict_batch(client):
    records = [
        {
            "tenure": 70, "monthly_charges": 25.0, "total_charges": 1750.0,
            "num_services": 1, "senior_citizen": 0, "contract": "two-year",
            "payment_method": "credit-card", "internet_service": "none",
            "paperless_billing": "no", "gender": "male",
        },
        {
            "tenure": 1, "monthly_charges": 105.0, "total_charges": 105.0,
            "num_services": 5, "senior_citizen": 1, "contract": "month-to-month",
